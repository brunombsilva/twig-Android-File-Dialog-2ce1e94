...
public class FileDialogOptions {
    ...
    public boolean chooseFolder = false;
    ...
    public static final String OPTION_CHOOSE_FOLDER = "OPTION_CHOOSE_FOLDER";
...
//  public static final String RESULT_PATH = "RESULT_PATH";
    ...
    public FileDialogOptions(Intent intent) {
        ...
        this.chooseFolder = intent.getBooleanExtra(OPTION_CHOOSE_FOLDER, false);
